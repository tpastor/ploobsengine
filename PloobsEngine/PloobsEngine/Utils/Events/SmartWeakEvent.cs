...
namespace PloobsEngine.Utils
{
	...
	public sealed class SmartWeakEvent<T> where T : class
	{
		struct EventEntry
		{
            ...
            public readonly System.WeakReference TargetReference;

            public EventEntry(FastSmartWeakEventForwarderProvider.ForwarderDelegate forwarder, MethodInfo targetMethod, System.WeakReference targetReference)
			{
	...
	{
        static readonly MethodInfo getTarget = typeof(System.WeakReference).GetMethod("get_Target");
        static readonly Type[] forwarderParameters = { typeof(System.WeakReference), typeof(object), typeof(EventArgs) };
        internal delegate bool ForwarderDelegate(System.WeakReference wr, object sender, EventArgs e);
		...
		internal static ForwarderDelegate GetForwarder(MethodInfo method)
		{
			...
			DynamicMethod dm = new DynamicMethod(
				"SmartWeakEvent", typeof(bool), forwarderParameters, method.DeclaringType);

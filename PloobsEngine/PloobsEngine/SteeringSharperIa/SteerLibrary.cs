...
namespace Bnoerj.AI.Steering
{
	...
	public abstract class SteerLibrary : AbstractVehicle
	{
        ...
        public Vector3 SteerForWander(float dt)
		{
            ...
            WanderSide = MathUtils.ScalarRandomWalk(WanderSide, speed, -1, +1);
			WanderUp = MathUtils.ScalarRandomWalk(WanderUp, speed, -1, +1);
        ...
        public Vector3 xxxSteerForFlee(Vector3 target)
		{
            ...
            Vector3 desiredVelocity = VectorUtils.TruncateLength(offset, this.MaxSpeed); //xxxnew
			return desiredVelocity - this.Velocity;
		}
			...
			foreach (IVehicle other in others)
			{
				if (other != this/*this*/)
				{
					...
					if (currentDistance < minCenterToCenter)
					{
                        ...
                        return VectorUtils.PerpendicularComponent(-offset, this.Forward);
					}
				}
			}
        ...
        public Vector3 SteerForPursuit(IVehicle quarry, float maxPredictionTime)
		{
			...
			int f = MathUtils.IntervalComparison(forwardness, -0.707f, 0.707f);
			int p = MathUtils.IntervalComparison(parallelness, -0.707f, 0.707f);
        ...
        public Vector3 SteerForTargetSpeed(float targetSpeed)
		{
			...
			return this.Forward * MathUtils.Clip(speedError, -mf, +mf);
		}

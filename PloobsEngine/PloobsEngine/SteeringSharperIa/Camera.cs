	...
	public class Camera : LocalSpace
	{
		...
		public void SmoothCameraMove(Vector3 newPosition, Vector3 newTarget, Vector3 newUp, float elapsedTime)
		{
			if (smoothNextMove)
			{
                ...
                Vector3 tempUp = Up;
				MathUtils.BlendIntoAccumulator(smoothRate, newPosition, ref tempPosition);
                MathUtils.BlendIntoAccumulator(smoothRate, newTarget, ref Target);
                MathUtils.BlendIntoAccumulator(smoothRate, newUp, ref tempUp);

...
{
    public class BindGestureCommand : ICommand
    {
        private InputPlaybleGesture ip;
        ...
        public BindGestureCommand(InputPlaybleGesture ip, BindAction ba)
        {
            this.ip = ip;
            this.ba = ba;
        }

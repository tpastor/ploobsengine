...
namespace PloobsEngine.Material
{
    ...
    /// </summary>
    public class ForwardAlphaTestShader : IShader
    {
        int alphaToCut;
        CompareFunction CompareFunction;
        public ForwardAlphaTestShader(int alphaToCut,CompareFunction CompareFunction)
        {
            this.alphaToCut = alphaToCut;
            this.CompareFunction = CompareFunction;
        }
        
        private AlphaTestEffect effect;

        public AlphaTestEffect DualTextureEffect
        {
            get { return effect; }            
        }

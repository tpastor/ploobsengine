...
namespace PloobsEngine.AssetLoader
{
    /// <summary>
    ...
    public class ContentBuilder : IDisposable
    {
        ...
        private List<String> PipelineAssemblies = new List<string>()
        {
        ...
        /// </summary>
        public ContentBuilder(GraphicsProfile GraphicsProfile = Microsoft.Xna.Framework.Graphics.GraphicsProfile.HiDef, List<String> PipelineAssemblies = null)
        {
            if (PipelineAssemblies != null)
            {
                this.PipelineAssemblies.AddRange(PipelineAssemblies);
            }
        ...
        void CreateBuildProject()
        {
            ...
            if (GraphicsProfile == Microsoft.Xna.Framework.Graphics.GraphicsProfile.HiDef)
            {

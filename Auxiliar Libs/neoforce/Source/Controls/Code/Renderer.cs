...
namespace TomShane.Neoforce.Controls
{
	...
	public class Renderer : Component
	{
		...
		public virtual void Draw(Texture2D texture, Rectangle destination, Color color)
		{
			...
			{
				sb.Draw(texture, destination, null, color, rotation, Vector2.Zero, SpriteEffects.None, Manager.GlobalDepth);
			}
		}
		////////////////////////////////////////////////////////////////////////////
		...
		public virtual void Draw(Texture2D texture, Rectangle destination, Rectangle source, Color color)
		{
			...
			{                
				sb.Draw(texture, destination, source, color, rotation, Vector2.Zero, SpriteEffects.None, Manager.GlobalDepth);                
			}
		}
		////////////////////////////////////////////////////////////////////////////
		...
		{
			sb.Draw(texture, new Vector2(left, top), null, color, rotation, Vector2.Zero, 1.0f, SpriteEffects.None, Manager.GlobalDepth);
		}
		////////////////////////////////////////////////////////////////////////////
		...
		public virtual void Draw(Texture2D texture, int left, int top, Rectangle source, Color color)
		{
			...
			{
				sb.Draw(texture, new Vector2(left, top), source, color, rotation, Vector2.Zero, 1.0f, SpriteEffects.None, Manager.GlobalDepth);
			}
		}
		////////////////////////////////////////////////////////////////////////////
		...
		{
			sb.DrawString(font, text, new Vector2(left, top), color, rotation, Vector2.Zero, 1.0f, SpriteEffects.None, Manager.GlobalDepth);
		}
		////////////////////////////////////////////////////////////////////////////

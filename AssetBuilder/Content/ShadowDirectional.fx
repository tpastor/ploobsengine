...
technique NORMAL
{
    pass Pass1
    {
        ...
        //PixelShader = compile ps_4_0 PixelShaderFunctionPCF3x3();
        //PixelShader = compile ps_4_0 PixelShaderFunctionPCF2x2Variance();        
        PixelShader = compile ps_4_0 PixelShaderFunction();
        //PixelShader = compile ps_4_0 PixelShaderFunctionPCFNxN();        
...
technique PCF2x2
{
    ...
    {
        VertexShader = compile vs_4_0 VertexShaderFunction();        
        PixelShader = compile ps_4_0 PixelShaderFunctionPCF2x2();        
...
technique DEFERREDPCF3x3
{
    ...
    {
        VertexShader = compile vs_4_0 VertexShaderFunction();
        PixelShader = compile ps_4_0 PixelShaderFunctionPCF3x3DEFERRED();
    }
}
...
technique DEFERREDPCF3x3AFTER
{
    ...
    {
        VertexShader = compile vs_4_0 VertexShaderFunction();
        PixelShader = compile ps_4_0 PixelShaderFunctionPCF3x3DEFERREDAFTER();
    }
}

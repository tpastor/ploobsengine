...
float4 DrawShadowsPSPoint(float2 TexCoord  : TEXCOORD0) : COLOR0
{
...
float4 BlurVerticallyPS(float2 TexCoord  : TEXCOORD0) : COLOR0
{
	  ...
	  float4 result = sum * attenuation * intensity ;
	  //float4 result = sum * 1;
...
technique ComputeDistances
{
    ...
    {          
        ...
        PixelShader  = compile ps_4_0 ComputeDistancesPS();
    }
}
...
technique Distort
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 DistortPS();
    }
}

technique DrawShadowsPoint
{
    pass P0
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 DrawShadowsPSPoint();
    }
}

technique DrawShadowsSpot
{
    pass P0
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 DrawShadowsPSSpot();
    }
}

						...
						uniform int iFilterSize	)	: COLOR0
{
    ...
    float4 vPositionVS;
    vPositionVS.x = in_vTexCoord.x * 2.0f - 1.0f;
    vPositionVS.y = -(in_vTexCoord.y * 2.0f - 1.0f);
    vPositionVS.z = depthVal;
    vPositionVS.w = 1.0f;
    //transform to view space
    vPositionVS = mul(vPositionVS, g_matInvProj);
...
technique CreateShadowTerm2x2PCF
{
    pass p0
    {
        ...
        PixelShader = compile ps_4_0 ShadowTermPS(2);	
    }
}
...
technique CreateShadowTerm3x3PCF
{
    pass p0
    {
        ...
        VertexShader = compile vs_4_0 ShadowTermVS();
        PixelShader = compile ps_4_0 ShadowTermPS(3);	
    }
}
...
technique CreateShadowTerm5x5PCF
{
    pass p0
    {
        ...
        VertexShader = compile vs_4_0 ShadowTermVS();
        PixelShader = compile ps_4_0 ShadowTermPS(5);	
    }
}
...
technique CreateShadowTerm7x7PCF
{
    pass p0
    {
        ...
        VertexShader = compile vs_4_0 ShadowTermVS();
        PixelShader = compile ps_4_0 ShadowTermPS(7);	
    }
}

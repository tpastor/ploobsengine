...
namespace ProjectTemplate
{
    ...
    /// </summary>
    public class ColladaFormatScreen : IScene
    {
        /// <summary>
        ...
        protected override void Draw(GameTime gameTime, RenderHelper render)
        {
            ...
            render.RenderTextComplete("Demo: Collada Model (Move the camera using WASD and Mouse)", new Vector2(10, 15), Color.Red, Matrix.Identity);
        }

...
namespace ProjectTemplate
{
    ...
    /// </summary>
    public class BoltSample : IScene
    {
        /// <summary>
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                BoltObject bo = new BoltObject(GraphicFactory, this.World.CameraManager.ActiveCamera.Position, this.World.CameraManager.ActiveCamera.Target - this.World.CameraManager.ActiveCamera.Position);

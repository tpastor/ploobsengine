...
namespace AdvancedDemo4._0
{
    ...
    /// We use the http://www.xnaparticles.com/ for the particles
    ...
    public class ParticleScreen : IScene
    {
        ...
        protected override void Draw(GameTime gameTime, RenderHelper render)
        {
            ...
            render.RenderTextComplete("Demo Particle System Integration", new Vector2(10, 15), Color.White, Matrix.Identity);
        }

...
namespace ProjectTemplate
{
    ...
    /// </summary>
    public class CrowedScreen : IScene
    {
        /// <summary>
        ...
        protected override void Draw(GameTime gameTime, RenderHelper render)
        {
            ...
            render.RenderTextComplete("Demo: Basic Screen Forward (Move the camera using WASD and Mouse)", new Microsoft.Xna.Framework.Vector2(10, 15), Color.Red, Matrix.Identity);
        }
